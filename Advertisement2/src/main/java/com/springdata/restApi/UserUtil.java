...
public class UserUtil {
	...
	public static List<com.springdata.restApi.UserJson> convertUserEntityListToUserList(List<User> userEntityList) {
		List<com.springdata.restApi> userList = new ArrayList<com.springdata.restApi>();
	...
	public static com.springdata.restApi.UserJson convertUserEntityToUser(User userEntity) {
		return new com.springdata.restApi(userEntity.getId(), userEntity.getUserName(), userEntity.getFirstName(), userEntity.getLastName(),userEntity.getPassword(),userEntity.getEmail(),userEntity.getPhone());
	}
